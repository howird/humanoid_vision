...
def setup_predictor(cfg: PhalpConfig, smpl_model) -> PoseTransformerV2:
...
def setup_detectron2(cfg: PhalpConfig) -> DefaultPredictor_Lazy:
    ...
    if cfg.phalp.detector == "maskrcnn":
        ...
        cfg_path = (
            Path(humanoid_vision.__file__).parent
            / "configs"
